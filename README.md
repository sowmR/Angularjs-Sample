# `angular-sample` —  AngularJS apps with examples of main features.

This project is an application derived from the basic Angular seed. The seed is then modified to show various features of AngularJs 
...
### Now Lets work on the seed. 
## Adding home page- using Controllers, Factory and routing
Our home page here is view1.html. We make changes to the basic home page with a simple form. And we write unit test codes for the page.
